...
description: 過去の Claude Code セッションをキーワード検索し、経緯・結論の確認や resume コマンドの提示を行う。過去の議論・決定を記憶で答えず、ログを検索してから答える。トリガー - 前のセッション, 〜してたセッション探して, resume したい, あの続き, セッションなかったっけ, 前にやってたやつ, なんで〜だっけ, 結論どうなったんだっけ, 前に話したよね, あれどうなったっけ, 何をやろうとしてたか
---
